...
public class AgendamentoService {
    ...
    public Agendamento solicitarAgendamento(Agendamento agendamento) {
        Agendamento ag = agendamentoRepository.findByDataAndHorarioAndNumerolaboratorio(agendamento.getData(), agendamento.getHorario(), agendamento.getNumerolaboratorio());
